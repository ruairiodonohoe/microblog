...
from microblog.main.forms import (
    EditProfileForm,
    EmptyForm,
    PostForm,
    SearchForm,
...
def search():
    ...
    next_url = (
        url_for("main.search/", q=g.search_form.q.data, age=page + 1)
...
def send_message(recipient):
    ...
    if form.validate_on_submit():
        ...
        db.session.add(msg)
        user.add_notification("unread_message_coutn", user.unread_message_count())
        db.session.commit()
